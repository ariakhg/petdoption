...
try {
  ...
  $sql_pets = "INSERT INTO `pets` (`Pet_ID`, `User_ID`, `Center_ID`, `Name`, `AnimalType`, `Breed`, `Gender`, `Weight`, `Height`, `Photo`, `DOB`, `AdoptionStatus`, `Color`, `MedicalHistory`, `Description`, `DateListed`) VALUES
              ('1', NULL, '1', 'Max', 'Dog', 'Golden Retriever', 'Male', 30, 60, 'max.jpg', '2021-05-01', 'Available', 'Golden', 'Vaccinated, Neutered', 'Max is an energetic and friendly Golden Retriever who loves to play fetch and run in open spaces. He is great with kids and other pets, making him the perfect family dog. Max enjoys long walks and cuddling up on the couch after a fun day outdoors. He is fully vaccinated and neutered, and his ideal home is one with a yard or active lifestyle.', CURRENT_TIMESTAMP),
              ('2', NULL, '2', 'Bella', 'Cat', 'Siamese', 'Female', 5, 25, 'bella.jpg', '2020-08-15', 'Adopted', 'Brown', 'Vaccinated', 'Bella is a calm and affectionate Siamese cat with a gentle nature. She loves curling up in cozy spots and being pampered with attention. Bella is ideal for a quiet home where she can be the center of attention. She is litter box trained, fully vaccinated, and enjoys sitting by the window, watching the world go by.', CURRENT_TIMESTAMP),
